...
class WalletsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wallet" do
    assert_difference('Wallet.count') do
      post wallets_url, params: { wallet: { buy: @wallet.buy, sell: @wallet.sell, total: @wallet.total } }
    end
  ...
  test "should update wallet" do
    patch wallet_url(@wallet), params: { wallet: { buy: @wallet.buy, sell: @wallet.sell, total: @wallet.total } }
