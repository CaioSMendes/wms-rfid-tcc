...
class TaxesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tax" do
    assert_difference('Tax.count') do
      post taxes_url, params: { tax: { costAdd: @tax.costAdd, icms: @tax.icms, ipi: @tax.ipi, shipping: @tax.shipping } }
    end
  ...
  test "should update tax" do
    patch tax_url(@tax), params: { tax: { costAdd: @tax.costAdd, icms: @tax.icms, ipi: @tax.ipi, shipping: @tax.shipping } }
